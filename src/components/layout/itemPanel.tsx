...
export default function ItemPanel({organizers}:ItemBlock){
    return (
        <div className="bg-[#1B1C1F99] w-[95%] rounded-2xl">
            <div className="flex justify-between items-center bg-gunmetal pr-4 pl-4 p-2 rounded-t-2xl rounded-b-none">
                <h2 className="text-xl text-white">Организаторы</h2>
                <button>
                    <Image src={plus} alt="menu" width={15} height={15} />
                </button>
            </div>
            <div className={`space-y-2 p-4 max-h-[180px] overflow-y-auto ScrollBar`}>
