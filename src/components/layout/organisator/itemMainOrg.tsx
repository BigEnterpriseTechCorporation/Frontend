...
export default function ItemPanel({organizers, title}:ItemBlock){
    ...
    return (
        <div className={`${isDarkTheme ? 'bg-[#1B1C1F99]' : 'bg-[#87879975]'}  w-full h-full rounded-2xl overflow-hidden`}>
            ...
            <div className={`space-y-2 p-3 max-h-[85%] overflow-y-auto ScrollBar`}>
