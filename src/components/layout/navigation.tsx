...
export default function Navigation() {
	...
	return (
		<>
			<nav className={`${isDarkTheme ? 'bg-gunmetal border-[#1D1D1D]' : 'bg-antiGunmetal border-[#D8DBDF]'} rounded-3xl flex justify-between items-center gap-6 py-2 px-4 w-max border max-[680px]:w-[90%] max-[680px]:h-18 max-[426px]:hiddenself-center justify-self-center`}>
